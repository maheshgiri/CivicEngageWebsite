...
if(session.getAttribute("user") == null){
    ...
    response.sendRedirect("/CivicEngagement/indexnouser.jsp");
}
%>
...
<a href='AmravatiCityUser.jsp' class='label label-success' rel='tooltip' title='View Details'>Explore your City</a>
</div>
