...
if(session.getAttribute("admin") != null){
    System.out.println("in user profile"+session.getAttribute("admin"));
...
%>
      ...
      <!-- Link or button to toggle dropdown -->
          ...
          <form  method="post" action="./AdminLogin" name="loginform" role="search"  style="padding-left:20px;width:270px;border: 1px solid rgb(204, 204, 204);border-radius:5px" >
                                         
          								  
        								<legend class="text-info" style="width:200px"> Admin Login</legend>
