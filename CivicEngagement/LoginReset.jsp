...
%>
      ...
      <!-- Link or button to toggle dropdown -->
                    <ul class="dropdown-menu" role="menu"  style="border-radius:10px;width:280px">
                                     ...
                                     <fieldset>
                                     <div class="form-group">
                                          <a  class="btn btn-primary" href="#"  style="margin-bottom:10px;">Login with facebook</a>
                                        </div>    
                                            <div class="form-group">
          ...
          <p class="text-success" >Your temporary password is emailed to you. </br>Use that password to login.</p>
          <form  method="post" action="./login" name="loginform" role="search"  style="padding-left:20px;width:270px;border: 1px solid rgb(204, 204, 204);border-radius:5px" >
                                         
          								  
        								<legend class="text-info" style="width:200px">Login</legend>
