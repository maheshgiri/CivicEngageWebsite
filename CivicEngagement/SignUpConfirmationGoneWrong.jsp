...
%>
      ...
      <!-- Link or button to toggle dropdown -->
         ...
         <label class="text-danger">Something went wrong try again.</label>
          <p class="text-success">Confirmation code has been sent to your mail.</p>
         <form method="post" action="./SignUpConfirmation" style="padding-left:20px;width:270px;border: 1px solid rgb(204, 204, 204);border-radius:5px">
          
         
        
         <div class="form-group col-lg-12 col-sm-12 col-md-12">
         <input type="email" name="email" placeholder="Registered usermane" class="form-control" style="margin-bottom:10px;margin-top:10px" required>
        
         </div>
         
          <div class="form-group col-lg-12 col-sm-12 col-md-12">
         <input type="text" name="confirmationcode" placeholder="paste confirmation code here." class="form-control" style="margin-bottom:10px;margin-top:10px" required>
