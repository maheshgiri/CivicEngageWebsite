...
%>
      ...
      <!-- Link or button to toggle dropdown -->
          ...
          <div class="container col-lg-offset-5" >
           ...
           <p class="text-success">Reset code has been sent to your email address.</p>
         <form method="post" action="./PasswordReset" style="padding-left:20px;width:270px;border: 1px solid rgb(204, 204, 204);border-radius:5px">
          
         
        
         <div class="form-group col-lg-12 col-sm-12 col-md-12">
         <input type="email" name="email" placeholder="Enter username" class="form-control" style="margin-bottom:10px;margin-top:10px" required>
        
         </div>
         
          <div class="form-group col-lg-12 col-sm-12 col-md-12">
         <input type="text" name="resetcode" placeholder="paste your reset code here." class="form-control" style="margin-bottom:10px;margin-top:10px" required>
