...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $('#RequestTableContainer').jtable({
            title: 'Request Analyser',
            paging: true, //Enable paging
            pageSize:5, //Set page size (default: 10)   
                  
            actions: {
                listAction: 'RequestCRUDController?action=list',
                createAction:'RequestCRUDController?action=create',
                updateAction: 'RequestCRUDController?action=update',
                deleteAction: 'RequestCRUDController?action=delete'
            },
            fields: {
                requestid: {
                    title:'RequestID',
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#DepartmentTableContainer').jtable({
            ...
            actions: {
                listAction: 'DepartmentCRUDController?action=list',
                createAction:'DepartmentCRUDController?action=create',
                updateAction: 'DepartmentCRUDController?action=update',
                deleteAction: 'DepartmentCRUDController?action=delete'
            },
            fields: {
                departmentid: {
                    title:'DepartmentID',
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#CityTableContainer').jtable({
            ...
            actions: {
                listAction: 'CityCRUDController?action=list',
                createAction:'CityCRUDController?action=create',
                updateAction: 'CityCRUDController?action=update',
                deleteAction: 'CityCRUDController?action=delete'
            },
            fields: {
                cityid: {
                    title:'CityID',
...
<div class="tabbable" style="font-family:Cambria, 'Hoefler Text', 'Liberation Serif', Times, 'Times New Roman', serif">
  ...
  <ul class="nav nav-tabs">
    <li class="active"><a href="#tab1" data-toggle="tab"><span class="icon-home"></span>Requests</a></li>
    <li><a href="#tab2" data-toggle="tab"><span class="iconfix-black"></span>Department Details</a></li>
    <li><a href="#tab3" data-toggle="tab"><span class="icon-user"></span> City details</a></li>
...
<a href="pendingrequests.jsp" style="margin-top:20px;font-family:Cambria, 'Hoefler Text', 'Liberation Serif', Times, 'Times New Roman', serif;font-size:20px;">Click to see delayed requests.</a>
</div>
...
<div id="DepartmentTableContainer" style="margin-top:10px"></div>
</div>
   </div>
   </div>
...
<div id="CityTableContainer" style="margin-top:10px"></div>
</div>
