...
<!--<script src="css/js/YourIssuesFunction.js"></script>-->
  <script src="css/js/ClicknextfuncAurangabad.js" type="application/javascript"></script> 
...
xmlhttp2.open("POST","GetAllFilteredIssues?city="+100006+"&status="+rstatus+"&sortby="+sortby+"&type="+servicetype+"");
xmlhttp2.send();
...
xmlhttp1.open("POST","GetFilteredIssues?page=1&city="+100006+"&status="+rstatus+"&sortby="+sortby+"&type="+servicetype+"",true);
xmlhttp1.send();
...
<script src="css/js/OnChangeJSAurangabad.js"></script>
...
$(document).ready(function(){
    ...
    $.post("GetLocation?cityid=100006",
...
<script>
    ...
    $.get("GetChartInformation?cityid=100006",
...
if(session.getAttribute("user") == null){
    ...
    response.sendRedirect("/CivicEngagement/AurangabadCityNoUser.jsp");
}
%>
...
<h4><label>Some attractions in Aurangabad</label></h4>
 ...
 Situated at a distance of 5 km (3 mi), nestled amidst the hills are 12 Buddhist caves probably dating back to 3 A.D. Of particular interest are the Tantric influences evident in the iconography and architectural designs of the caves. One is also treated to a panoramic view of the city as well as the imposing Maqbara from this point.
     ...
     Is a 17th-century water mill situated at a distance of 1 km from the city. An intriguing water mill, the Panchakki is famous for its underground water channel, which traverses more than 8 km. to its source away in the mountains. The channel culminates in a mesmerising 'artificial' waterfall that powers the mill. The beauty of the mosque housed in the inner enclosure is enhanced by a series of 'dancing' water fountains.
      <img class="img-circle img-responsive" src="images/Panchakki_fountain,_Aurangabad.jpg"> 
      </p>
