...
xmlhttp3.open("POST","GetAllFilteredIssues?city="+100000+"&status="+rstatus+"&sortby="+sortby+"&type="+servicetype+"");
xmlhttp3.send();
...
xmlhttp4.open("POST","GetFilteredIssues?page=1&city="+100000+"&status="+rstatus+"&sortby="+sortby+"&type="+servicetype+"",true);
xmlhttp4.send();
