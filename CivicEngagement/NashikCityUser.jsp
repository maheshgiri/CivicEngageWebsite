...
<!--<script src="css/js/YourIssuesFunction.js"></script>-->
  <script src="css/js/ClicknextfuncNashik.js" type="application/javascript"></script> 
...
xmlhttp2.open("POST","GetAllFilteredIssues?city="+100005+"&status="+rstatus+"&sortby="+sortby+"&type="+servicetype+"");
xmlhttp2.send();
...
xmlhttp1.open("POST","GetFilteredIssues?page=1&city="+100005+"&status="+rstatus+"&sortby="+sortby+"&type="+servicetype+"",true);
xmlhttp1.send();
...
<script src="css/js/OnChangeJSNashik.js"></script>
...
$(document).ready(function(){
    ...
    $.post("GetLocation?cityid=100005",
...
if(session.getAttribute("user") == null){
    ...
    response.sendRedirect("/CivicEngagement/NashikCityNoUser.jsp");
}
%>
...
<input id="clickcount" type="text"  style="display:none"   value="1">
   ...
   <div id="issues">
    ...
    <div class="tab-pane" id="tab3">
     ...
     <label>Nashik </label> is a located on the banks of the Godavari River, the holy river which flows through old Nashik. Nasik is the highest producer of grapes in India along with onions. The Nassak Diamond, derives its name from the fact that it long remained in the Trimbakeshwar Shiva Temple, near Nashik. The Godavari River flows through Nashik from its source, which lies to the southwest of the city, in Trimbakeshwar.
Subsequently ranked as fourth fastest growing city of India and sixteenth of the world, Nashik is known for its pleasant climate, picturesque surroundings and greenery. It is the third largest city of Maharshtra after Mumbai and Pune . Nasik is shortlisted in Delhi Mumbai Industrial Corridor(DMIC) as an investment region for the circle Igatpuri-Nasik-Sinnar. 
     </p>
     <p>
Nashik is a city in western India in the state of Maharashtra. Nashik is located in the north-west of Maharashtra, 171 km (106 mi) from Mumbai and 210 km (130 mi) from Pune.It is the biggest city of North Maharashtra and 11th most populated district in India.Nashik district is the third largest district in Maharashtra after Ahmednagar and Pune.

</p>
<h4><label>Some attractions in Nahik</label></h4>
      <p>
      <h5><label>Kumbh Mela</label></h5>
Nashik host one of the largest religious gathering in the world known as Maha Kumbh. Kumbh mela (festival) is celebrated once in twelve years. The Ardh (half) Kumbh Mela is celebrated every six years at Haridwar and Allahabad, the Purna (complete) Kumbh takes place every twelve years at four places in Allahabad, Haridwar, Ujjain, and Nashik. Previous kumbh mela was in year 2003. Next kumbh mela will be held from August 15 to September 13 in 2015.
       <img class="img-circle img-responsive" src="images/Nashik_during_1989_Kumbh_Mela.jpg"> 
      </p>
      
      <p>
      <h5><label> Gargoti Museum</label></h5>
  
       <img class="img-circle img-responsive" src="images/DSC00991.JPG"> 
      </p>
      <p>
      <h5><label> Trimbakeshwar</label></h5>
...
It is located at the source of the Godavari River, the longest river in peninsular India. The Godavari River, which is considered sacred within Hinduism, originates from Bramhagiri mountains and meets the sea near Rajahmudry. Kusavarta, a kund is considered the symbolic origin of the river Godavari, and revered by Hindus as a sacred bathing place. The current temple was built by Peshwa Balaji Baji Rao.
      <img class="img-circle img-responsive" src="images/trimbakeshwar_1367860691.jpg"> 
      </p>
    </div>
