...
<meta http-equiv="cache-control"  content="no-cache" > 
 <link rel="shortcut icon" href="images/repair_icon.png">
   ...
   {
	   $("#passsavehint").show().delay(2000).fadeOut();
	   document.getElementById("passsavehint").setAttribute("hidden","hidden");	   
   }
   </script>
...
<div class="tabbable">
  ...
  <ul class="nav nav-tabs" id="myTab">
     <li  ><a href="#tab1" data-toggle="tab"><span class="icon-home"></span>Dashboard</a></li>
   ...
   <!-- <li><a href="#tab4" data-toggle="tab"><span class="icon-user"></span>Suggested Neighbours</a></li>-->
    <li class="active" ><a href="#tab5" data-toggle="tab"><span class="icon-edit" ></span>Change Password</a></li>
  ...
  <div class="tab-content">
   <div   class="tab-pane " id="tab1" >
     ...
     <img src="<%=source %>" alt="" class="img-rounded " id="photobox" style="margin-top:10px;height:150px" >
      ...
      <button type="button"  id="fileUploadButton" class="btn btn-primary"  onClick="getfile()" style="margin-bottom:10px">       <span class="icon-camera icon-white" ></span> Update Photo</button>
     ...
     <input type="button"  value="Edit" id="editbtn" class="btn btn-primary"  style="margin-top:10px"   onClick="EnableFields()">
...
%>
    ...
    <div class="col-lg-8 col-sm-8 col-md-8 help-block">
     <label class="text-success" id="passsavehint" hidden="hidden">Password saved successfully.</label>
    </div>
