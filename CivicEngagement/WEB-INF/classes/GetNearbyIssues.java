 ...
 */
public class GetNearbyIssues extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetNearbyIssues() {
        super();
...
//out.println("Select * from content limit "+offset+" ,"+rowsperpage +" ");
 rs=stmt.executeQuery("Select * from Requests where CityID='"+tempcityid+"' limit "+offset+" ,"+rowsperpage +" ");
...
out.write("</span>");
  ...
  out.write("<p class='text-info' style='margin-top:5px'>");
         out.write("<span class='text-success'><span class='icon-check'></span>   "+ status+".</span></p>");
