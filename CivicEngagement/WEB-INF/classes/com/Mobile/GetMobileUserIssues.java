...
String user=request.getParameter("mobUser");
...
if(pagenum>=1&&pagenum<=total_pages)
{
    ...
    while(rs.next())
    {
      ...
      out.write(" <li class='media'>");
       ...
       out.write("<a class='pull-right' href='#' title='"+requesttype+"'>");
         ...
         out.write(" </a>");
          out.write("<div class='media-body' style='margin-left:10px;margin-top:10px;font-family:Cambria, Hoefler Text, Liberation Serif, Times, Times New Roman, serif' >");
            out.write("<h4 class='media-heading'><a href='#' title='"+requesttype+"' style='text-decoration:none'>"+requesttype+"</a>");
