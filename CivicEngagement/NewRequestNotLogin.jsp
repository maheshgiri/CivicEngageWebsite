...
%>
      ...
      <!-- Link or button to toggle dropdown -->
          ...
          <p class="text-danger">Please login to make request.</p>
          <form  method="post" action="./NewRequestLogin" name="loginform" role="search"  style="padding-left:20px;width:270px;border: 1px solid rgb(204, 204, 204);border-radius:5px" >
