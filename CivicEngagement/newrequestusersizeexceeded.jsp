...
.navbar-collapse {
	...
	{  
		...
		var img=document.getElementById("inputfile").value.toLowerCase();
...
var addr=document.getElementById("cityname").value.toLowerCase();
		 ...
		 if(addr.indexOf("pune")==-1 && addr.indexOf("mumbai")==-1  && addr.indexOf("nagpur")==-1  && addr.indexOf("pimpri")==-1  && addr.indexOf("nashik")==-1  && addr.indexOf("aurangabad")==-1  && addr.indexOf("solapur")==-1  && addr.indexOf("amravati")==-1  && addr.indexOf("nanded")==-1 )
		 { 
...
%>
  ...
  <!-- Link or button to toggle dropdown -->
    ...
    <lable class="text-danger">File size exceeded.</label>
     <div class=" sign-in-form">
     
     
     
        <input name="lat" type="text" value="" hidden="hidden">
        <input name="lng" type="text" value="" hidden="hidden">
      
     <div class="row">  
     <div class="col-lg-6 col-sm-6 ">
      <label> 1.Enter request location</label>
     ...
     <div class="row">
     <div class="col-lg-6 col-sm-6" >
     <input id="geocomplete" type="text" name="requestlocation" class="form-control" placeholder="Enter location of request" style="margin-bottom:10px"    required/>
    ...
    <div class="map_canvas" style="height:280px;margin-bottom:10px"></div>
     ...
     <div class="col-lg-6 col-sm-6 ">
      ...
      <div class="row">
      <div class="col-lg-6 col-sm-6" >
      <select name="city" lang="en" xml:lang="en"  type="text" value="" class="form-control" placeholder="Enter the name of the city " id="cityname" required style="margin-bottom:10px" >
