...
%>
      ...
      <!-- Link or button to toggle dropdown -->
          ...
          <div class="container col-lg-offset-5" >
           ...
           <p class="text-success">Your sign up is successfull</p>
          ...
          <form  method="post" action="./login" name="loginform" role="search"  style="padding-left:20px;width:270px;border: 1px solid rgb(204, 204, 204);border-radius:5px" >
        								...
        								<legend class="text-success" style="width:200px">Login</legend>
                                            ...
                                            <div class="form-group col-lg-12 col-md-12 col-sm-12  ">
                                             ...
                                             <a  class="btn btn-primary" href="#" style="margin-bottom:10px;margin-top:10px">Login with facebook</a>
                                            </div>
