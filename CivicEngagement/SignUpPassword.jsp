...
%>
      ...
      <!-- Link or button to toggle dropdown -->
          ...
          <h5 class="text-info" style="font-family:Cambria, 'Hoefler Text', 'Liberation Serif', Times, 'Times New Roman', serif">
          ...
          <div class="row" style="margin-bottom:10px">
          <input type="text"  name="signup_city"  class="form-control"  placeholder="City">
